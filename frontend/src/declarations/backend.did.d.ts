...
export type Category = { 'womensWear' : null } |
  { 'mensWear' : null } |
  { 'accessories' : null } |
  { 'kidsWear' : null } |
  { 'ethnicWear' : null };
...
export interface _SERVICE {
  ...
  'addProduct' : ActorMethod<
    [string, Category, bigint, string, string],
    bigint
  >,
  ...
  'getProductsSortedByName' : ActorMethod<[], Array<Product>>,
  'getProductsSortedByPrice' : ActorMethod<[], Array<Product>>,
  'updateProduct' : ActorMethod<
    [bigint, string, Category, bigint, string, string],
    undefined
  >,
}
