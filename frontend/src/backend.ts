...
import type { Category as _Category, Product as _Product, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: Category, arg2: bigint, arg3: string, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addProduct(arg0, to_candid_Category_n8(this._uploadFile, this._downloadFile, arg1), arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProductsSortedByName(): Promise<Array<Product>> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: Category, arg3: bigint, arg4: string, arg5: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProduct(arg0, arg1, to_candid_Category_n8(this._uploadFile, this._downloadFile, arg2), arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "womensWear" in value ? Category.womensWear : "mensWear" in value ? Category.mensWear : "accessories" in value ? Category.accessories : "kidsWear" in value ? Category.kidsWear : "ethnicWear" in value ? Category.ethnicWear : value;
}
...
function to_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category): {
    ...
    return value == Category.womensWear ? {
        womensWear: null
    } : value == Category.mensWear ? {
        mensWear: null
    } : value == Category.accessories ? {
        accessories: null
    } : value == Category.kidsWear ? {
        kidsWear: null
    } : value == Category.ethnicWear ? {
        ethnicWear: null
    } : value;
}
